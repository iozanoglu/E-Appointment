...
@ViewChild("addModalCloseBtn") addModalCloseBtn: ElementRef<HTMLButtonElement> | undefined; // viewChild'ı ViewChild olarak değiştirdim(import kısmında da) ama hoca sorun yaşamamıştı??
@ViewChild("updateModalCloseBtn") updateModalCloseBtn: ElementRef<HTMLButtonElement> | undefined; // viewChild'ı ViewChild olarak değiştirdim(import kısmında da) ama hoca sorun yaşamamıştı??
